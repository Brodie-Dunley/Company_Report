--Total Number of orders since input date
...
--Total number of orders per single customer since input date
...
--total amount of orders in the company since input date
...
--total amount of orders per customer since input date
